...
function doQueryCheck(size1=48,size2=48) {
...
var check = function(){
  if( (countBalls >100 && i == 100) || (countBalls >200 && i  ==200) ||(countBalls >300 && i  ==300)  || (countBalls >300 && i  ==400) || (countBalls >100 && i  ==500) || (countBalls >100 && i  ==600) || (countBalls >100 && i  ==700) || (countBalls >100 && i  ==800) || (countBalls >100 && i  ==900) || (countBalls >100 && i  ==1000) ) {
      // returns a random integer from 1 to 10
// balls.reverse();
...
var c = $("#editCount").val()
  ...
  window.changeBall = function(str) {
    ballSrc = str;
  }
